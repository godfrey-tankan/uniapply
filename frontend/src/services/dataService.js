...
export const zimProvincesData = [
    { name: 'Harare', code: 'HAR' },
    { name: 'Bulawayo', code: 'BUL' },
    { name: 'Manicaland', code: 'MAN' },
    { name: 'Mashonaland East', code: 'MSE' },
    { name: 'Mashonaland West', code: 'MSW' },
    { name: 'Mashonaland Central', code: 'MSC' },
    { name: 'Masvingo', code: 'MAS' },
    { name: 'Matabeleland North', code: 'MATN' },
    { name: 'Matabeleland South', code: 'MATS' },
...
export const certificateTypes = [
        ...
        { name: 'Masters', code: 'MAST' },
        { name: 'PhD', code: 'PHD' }
    ];


export const qualificationTypes = [
        { name: 'O-Level', code: 'OLEVEL' },
        { name: 'A-Level', code: 'ALEVEL' },
