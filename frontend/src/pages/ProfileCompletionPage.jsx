                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full">
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        type="submit"
                                        disabled={loading || fileUploading || (missingFields.includes('education_history') && !hasEnoughEducationHistory)}
                                        className="bg-teal-700 hover:bg-teal-800 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-all duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
                                    >
                                        {loading ? (
                                            <>
