        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Enter your details to get started with UniApply
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Uncheck if you are a lecturer or staff member
                        </p>
                      </div>
                    </FormItem>
                  )}
                ...
                <Button
                  type="submit"
                  className="w-full bg-university-DEFAULT hover:bg-university-DEFAULT/90"
                  disabled={isLoading}
                >
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-center text-sm">
              ...
              <Link to="/login" className="text-university-DEFAULT hover:underline">
                Sign in
              </Link>
            </div>
          </CardFooter>
